...
U 1 1 54F0F652
P 6050 1750
F 0 "#PWR037" H 6050 1600 60  0001 C CNN
...
U 1 1 54F0F859
P 6850 2500
F 0 "#PWR038" H 6850 2250 60  0001 C CNN
...
U 1 1 54F0FED2
P 4300 2400
F 0 "#PWR039" H 4300 2150 60  0001 C CNN
...
U 1 1 54F1038C
P 2400 5000
F 0 "#PWR040" H 2400 4750 60  0001 C CNN
...
U 1 1 54F10510
P 2850 5050
F 0 "#PWR041" H 2850 4800 60  0001 C CNN
...
U 1 1 54F106DD
P 4600 4400
F 0 "#PWR042" H 4600 4150 60  0001 C CNN
...
U 1 1 54F261C8
P 6100 4450
F 0 "#PWR043" H 6100 4200 60  0001 C CNN
...
U 1 1 54F275CF
P 3800 5700
F 0 "#PWR044" H 3800 5450 60  0001 C CNN
...
U 1 1 54F27F36
P 4450 5700
F 0 "#PWR045" H 4450 5450 60  0001 C CNN
...
F 3 "" H 4450 5700 60  0000 C CNN
	...
	1    0    0    -1  
$EndComp
Text HLabel 7950 3250 2    60   Output ~ 0
HOA
Text HLabel 7950 3350 2    60   Output ~ 0
HSA
Text HLabel 7950 3050 2    60   Output ~ 0
LOA
...
U 1 1 54F27620
P 2100 2100
F 0 "#PWR046" H 2100 1950 60  0001 C CNN
...
U 1 1 54F27680
P 2900 2100
F 0 "#PWR047" H 2900 1950 60  0001 C CNN
...
U 1 1 54F279FB
P 9250 2050
F 0 "#PWR048" H 9250 1900 60  0001 C CNN
...
U 1 1 54F27A37
P 8300 2050
F 0 "#PWR049" H 8300 1900 60  0001 C CNN
...
OVP: Open drain output with an internal\npull-up resistor to VDD indicating \nOVS >VDD. OVP is low when OVS>VDD.
...
U 1 1 54F2A34D
P 7450 4100
F 0 "R37" H 7250 4150 50  0000 C CNN
F 1 "DNP" H 7600 4150 50  0000 C CNN
F 2 "Resistors_SMD:R_0805_HandSoldering" H 7450 4030 30  0001 C CNN
F 3 "" V 7450 4100 30  0000 C CNN
	1    7450 4100
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 54F2A414
P 8550 4000
F 0 "#PWR050" H 8550 3850 60  0001 C CNN
F 1 "Vout" H 8550 4150 60  0000 C CNN
...
U 1 1 54F2A6E3
P 6600 4700
F 0 "#PWR051" H 6600 4450 60  0001 C CNN
...
U 1 1 54F8B7CD
P 4550 1750
F 0 "#PWR052" H 4550 1600 60  0001 C CNN
